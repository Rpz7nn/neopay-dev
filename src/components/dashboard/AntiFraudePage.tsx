...
const AntiFraudePage = () => {
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-xl font-bold text-foreground">Anti Fraude</h1>
        <p className="text-muted-foreground">Gerencie bloqueios e regras de segurança</p>
      </div>
