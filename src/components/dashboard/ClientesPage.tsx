  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Veja a lista de usuários cadastrados em seu site.</p>
      </div>
        ...
        <table className="w-full">
          <thead className="bg-card">
            <tr className="border-b border-border">
              ...
              <th className="text-left py-4 px-6 text-sm font-medium text-muted-foreground">Está banido</th>
              <th className="text-center py-4 px-6 text-sm font-medium text-muted-foreground">Compras</th>
              <th className="text-left py-4 px-6 text-sm font-medium text-muted-foreground">Criado há</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td colSpan={4} className="text-center py-12 text-foreground font-medium">
